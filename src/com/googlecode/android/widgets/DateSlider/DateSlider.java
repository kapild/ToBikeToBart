...
//	private static String TAG = "DATESLIDER";
    ...
    private CompoundButton.OnCheckedChangeListener onCheckListener = new CompoundButton.OnCheckedChangeListener() {
        ...
        {
        	DateSlider.this.isChecked = isChecked;
        }
    ...
    private android.view.View.OnClickListener okButtonClickListener = new android.view.View.OnClickListener() {
        public void onClick(View v) {
            if (onDateSetListener!=null)
                onDateSetListener.onDateSet(DateSlider.this, getTime(), DateSlider.this.isChecked);
            dismiss();
        }
    };
    ...
    public interface OnDateSetListener {
         ...
         *
         */
        public void onDateSet(DateSlider view, Calendar selectedDate, boolean isClicked);
    }
}
